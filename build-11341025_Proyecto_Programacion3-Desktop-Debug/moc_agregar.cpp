...
#include "../11341025_Proyecto_Programacion3/agregar.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Agregar_t, stringdata) + ofs \
...
const QMetaObject Agregar::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_Agregar.data,
      qt_meta_data_Agregar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Agregar.stringdata))
        return static_cast<void*>(const_cast< Agregar*>(this));
